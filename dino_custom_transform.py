...
class GaussianBlur(object):
    """
    Apply Gaussian Blur to the Pytorch Tensor
    """
    ...
    def __call__(self, img):
        ...
        if not do_it:
            return img
        return F.gaussian_blur(img, kernel_size=self.kernel_size, sigma=(self.sigma_min, self.sigma_max))
